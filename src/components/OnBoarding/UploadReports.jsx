    ...
    <div className="bg-gradient-to-br from-blue-50 to-indigo-50/30 backdrop-blur-xl rounded-3xl p-8 border border-blue-200 shadow-xl shadow-blue-200/30 hover:shadow-2xl hover:shadow-blue-300/30 transition-all duration-300">
      ...
      >
        <h2 className="text-3xl font-bold text-slate-800 mb-3">
          Upload <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-indigo-600">Medical Reports</span>
        </h2>
        ...
        >
          ...
          {files.map((file, index) => (
            <motion.div
              ...
              className="bg-white border border-blue-100 rounded-xl p-4 flex items-center justify-between group hover:border-blue-300 hover:shadow-xl hover:shadow-blue-200/30 transform hover:-translate-y-1 transition-all duration-300"
            >
      ...
      <motion.div
        ...
        className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3 shadow-sm"
      >
      ...
      <div className="flex justify-between items-center pt-6 mt-6 border-t border-[#a855f7]/20">
        ...
        <div className="flex gap-3">
          <motion.button
            ...
            className="px-6 py-3 rounded-full font-semibold border-2 border-blue-100 text-slate-500 hover:border-blue-200 hover:text-slate-700 transition-all"
          >
            Skip for now
          </motion.button>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            onClick={handleNext}
            className="px-8 py-3 rounded-full font-semibold bg-gradient-to-r from-blue-500 to-indigo-600 text-white shadow-lg shadow-blue-200/50 hover:shadow-blue-300/80 transition-all flex items-center gap-2"
          >
            Continue
