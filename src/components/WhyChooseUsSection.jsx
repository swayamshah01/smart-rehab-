    ...
    <section id="why-us" ref={ref} className="py-24 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        <motion.div
          ...
          className="absolute top-40 right-40 w-72 h-72 bg-cyan-500/5 rounded-full blur-3xl"
        />
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          {reasons.map((reason, index) => (
            ...
            >
              <motion.div
                ...
                className="bg-gradient-to-br from-slate-800/50 to-purple-900/30 backdrop-blur-xl rounded-2xl p-8 border border-purple-500/20 h-full relative overflow-hidden group cursor-pointer"
              >
                {/* Animated Glow */}
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-cyan-500/0 via-purple-500/10 to-pink-500/0"
                  animate={{ x: ['-100%', '100%'] }}
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                  className="w-20 h-20 rounded-2xl bg-gradient-to-br from-cyan-400 to-purple-500 flex items-center justify-center mb-6 shadow-lg shadow-purple-500/50 group-hover:shadow-purple-500/80 transition-all"
                >
        ...
        <motion.div
          ...
          className="mt-16 bg-gradient-to-br from-slate-800/50 to-purple-900/30 backdrop-blur-xl rounded-3xl p-8 border border-purple-500/20"
        >
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="space-y-3">
                {['Real-time difficulty adjustment', 'Pain pattern recognition', 'Exercise modification suggestions'].map((item, i) => (
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-gradient-to-r from-cyan-400 to-purple-500 flex items-center justify-center flex-shrink-0">
            ...
            <motion.div
              ...
              className="bg-gradient-to-br from-slate-900/50 to-purple-900/50 rounded-2xl p-6 border border-cyan-400/20"
            >
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  <span className="text-white font-semibold">Pain Level</span>
                  <motion.span
                    key={5}
                    initial={{ scale: 1.5 }}
                    animate={{ scale: 1 }}
              ...
              <motion.div
                ...
                className="mt-4 p-4 bg-cyan-500/10 border border-cyan-400/30 rounded-lg"
              >
